...
Implementation notes: This applies a monkey patch to the
handleContentishEvent function from CMFCore.
The goal is to optimize performance by transfering existing catalog data
to a new path rather than doing a full unindex + reindex.
...
def handleContentishEvent(ob, event):  # noqa: C901
