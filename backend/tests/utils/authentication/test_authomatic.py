...
from kitconcept.core.utils.authentication import authomatic as utils
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["google", "google/access_headers/User-Agent", "Plone (kitconcept.core)"],
        ["github", "github/id", 1],
        ...
        ["github", "github/access_headers/User-Agent", "Plone (kitconcept.core)"],
    ],
)
